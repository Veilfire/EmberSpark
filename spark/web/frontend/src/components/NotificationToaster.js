...
export function NotificationToaster() {
    ...
    useEffect(() => {
        const handler = (n) => {
            if (!preferences?.toast_on_create)
                return;
    ...
    return (_jsx(Toaster, { position: "bottom-right", theme: "dark", richColors: true, closeButton: true, expand: true, visibleToasts: 4, toastOptions: {
            classNames: {
